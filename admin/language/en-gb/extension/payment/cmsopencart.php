...
$_['entry_route_cms']  	= 'Cmsopencart';
$_['entry_route_cs'] 	= 'Cs Pay';
$_['help_route'] 			= '% of total transactions to route to each gateway. This option will come into effect only if cmsopencart is configured.';
...
$_['entry_order_fail_status'] = 'Fail Order Status:';
$_['entry_order_cancel_status'] = 'Cancel Order Status:';
...
$_['error_status'] 			= 'Cmsopencart parameters must be configured to enable this module.';
